...
ctypes.windll.kernel32.SetConsoleTitleW('Proxy Checker | By Jesewe Hack')
...
if __name__ == '__main__':
    ...
    try:
        threads = int(
            input(bcolors.OKBLUE+'\n                                Threads (recommended = 100): ' + bcolors.ENDC))
    except Exception:
        threads = 100
    ...
    print(bcolors.OKCYAN +
          f'\n                                  Total unique proxies : {total_proxies}' + bcolors.ENDC)
